...
// UserBookingsController showUserBookingsController = new
// UserBookingsController();
// showUserBookingsController.setUsername(username);
// FXMLLoader loader = new
// FXMLLoader(getClass().getResource("userBookings.fxml"));
...
// SearchForRoomsController searchForRoomsController = new
// SearchForRoomsController();
// searchForRoomsController.setUsername(username);
// FXMLLoader loader = new
// FXMLLoader(getClass().getResource("searchForRooms.fxml"));
